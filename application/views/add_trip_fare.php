                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url() . 'trip/trip_fare_insert'; ?>" method="post">

                                <fieldset>
                                    <legend>Add Trip Fare</legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('goods',$data,$this->input->post('goods'),'class="form-control" id="goods" ');
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Standard Load (KG)</label>
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="/Kg" type="text" name="st_load" value="<?php echo $this->input->post('st_load');?>">
                                    ...
                                    <div id="extra">
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control" placeholder="/Kg" type="text" name="extra_load" value="<?php echo $this->input->post('extra_load');?>">
                                        ...
                                        <div class="col-md-3">
                                           <input type="text" placeholder="Taka" class="form-control" name="extra_charge" value="<?php echo $this->input->post('extra_charge')?>">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="Fare" id="fixed_fare" type="text" name="fixed_fare" value="<?php echo $this->input->post('fixed_fare'); ?>" />
                                            <span class="text-danger"><?php echo form_error('fixed_fare');?></span>
                                        </div>
                                    </div>
