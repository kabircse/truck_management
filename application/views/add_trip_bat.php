                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url() . 'trip/insert_trip_bat'; ?>" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                           <select name="goods" id="goods" class="form-control" placeholder="Fare">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                             <input class="form-control no_edit" placeholder="Fare" type="text" name="fare" id="fare" value="<?php echo $this->input->post('fare'); ?>">
                                            <span class="text-danger"><?php echo form_error('fare'); ?></span>
                                        </div>
                                        <label class="col-md-1 control-label">Total Load</label>
                                        <div class="col-md-3">
                                           <input class="form-control" placeholder="/Kg"  id="total_load" name="total_load" value="<?php echo $this->input->post('total_load'); ?> " autocomplete='off' />
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label"> Extra Weight</label>
                                         <div class="col-md-3">
                                            <input class="form-control no_edit" placeholder="Extra Weight" id="extra_weight" name="extra_weight" value="" />
                                            <span class="text-danger"><?php echo form_error('extra_weight'); ?></span>
                                         </div>
                                         <label class="col-md-1 control-label">Extra Fare</label>
                                         <div class="col-md-3">
                                                                                        
                                            <input class="form-control no_edit" placeholder="Extra Fare" id="extra_fare" name="extra_fare" value="">
