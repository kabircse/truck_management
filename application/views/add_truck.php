                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url() . 'truck/submit_truck'; ?>" method="post">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <?php
                                            if($results){
                                            $type_array = array(''=>'Select please');
                                            ...
                                            <?php }
                                                ...
                                                echo '<span class="text-danger">There is no type. First insert type, please.</span>';
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" placeholder="Truck Number" class="form-control" name="truck_number" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="Engine Number" type="text" name="engine_number" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="Chesis Number" type="text" name="chesis_number" value="">
