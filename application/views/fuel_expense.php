                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            <form class="form-horizontal" action="<?php echo base_url() . 'expense/submit_fuel_expense'; ?>" method="post">
                                <fieldset>
						    ...
						    ///if ($suppliers){
								...
								$suppliers_array[$supplier['id']] = $supplier['supplier_name'];
							     echo form_dropdown('supplier_id',$suppliers_array,'','class="form-control"');
						    //}
					?>
						    ...
						    ///if ($suppliers){
								...
								$trucks_array[$row['truck_id']] = $row['truck_number'];
							     echo form_dropdown('truck_id',$trucks_array,'','class="form-control"');
						    //}
					?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="Chalan No" type="text"  name="chalan_no" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control" placeholder="Quantity" id="quantity" type="text" name="quantity" value="">
                                            <span class="text-danger"><?php echo form_error('quantity');?></span>
                                        </div>

                                        <label class="col-md-2 control-label">Unit Price</label>
                                        <div class="col-md-3">
                                            <input class="form-control" placeholder="Unit Price" id="unit_price" type="text" name="unit_price" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" placeholder="Total Price" type="text" id="total_price" name="total_price" value="">
