													...
													<td>
														<div class="btn-group">
															...
															<ul class="dropdown-menu">
																...
																<li>
																	<a class="delete" href="<?php echo base_url().'trip/delete_bat_trip/'.$trip['trip_id'];?>">Delete</a>
																</li>
																<li>
																	<a class="delete" href="<?php echo base_url().'trip/bat_trip_finalize/'.$trip['trip_id'];?>">Finalize</a>
																</li>
